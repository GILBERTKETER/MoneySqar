...
$config = array(
    ...
    "key"              => "m73qhD8dlDWCjmdep89uqpPwvANNYSd5", //Enter your consumer key here
    "secret"           => "aCYAzlkNTJghgYYx", //Enter your consumer secret here
    "username"         => "apitest",
    "TransactionType"  => "CustomerPayBillOnline",
    "passkey"          => "bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919", //Enter your passkey here
    "CallBackURL"      => "https://f528-105-161-1-13.ngrok-free.app/callback.php", //When using localhost, Use Ngrok to forward the response to your Localhost
