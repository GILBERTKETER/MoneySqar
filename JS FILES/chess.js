    ...
    document.querySelectorAll('.box').forEach(image => {
        ...
        if (image.innerText.length !== 0) {
            if (image.innerText == 'Wpawn' || image.innerText == 'Bpawn') {
                image.innerHTML = `${image.innerText} <img class='allimg allpawn' src="../ASSETS/${image.innerText}.png" alt="alo">`
                ...
                image.innerHTML = `${image.innerText} <img class='allimg' src="../ASSETS/${image.innerText}.png" alt="alo">`
                image.style.cursor = 'pointer'
            }
        }
    })
