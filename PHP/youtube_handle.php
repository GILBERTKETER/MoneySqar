...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $Total_Earned = 50;
    $sql = "SELECT * FROM youtube_video WHERE Email_Address = '$email' AND Video_ID = '$videoId'";
    ...
    if (mysqli_num_rows($execute_sql) > 0) {
        ...
        // Insert the data
        $insert_Data = "INSERT INTO youtube_video (Email_Address, Amount_Earned, Video_ID)
